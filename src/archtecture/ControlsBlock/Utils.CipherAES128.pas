...
type
  TCipherAES128 = class
    class function Encrypt(Value, Password: string): string;
    class function Decrypt(Value, Password: string): string;
  end;
...
class function TCipherAES128.Encrypt(Value, Password: string): string;
var
  hCProv: HCRYPTPROV;
  hKey: HCRYPTKEY;
  lul_datalen: Integer;
...
class function TCipherAES128.Decrypt(Value, Password: string): string;
var
  hCProv: HCRYPTPROV;
  hKey: HCRYPTKEY;
  lul_datalen: Integer;
